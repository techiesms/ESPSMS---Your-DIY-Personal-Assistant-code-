...
void setup() {
 ...
 WiFiMulti.addAP("SSID", "Password"); //---------- Write you SSID and Password of yout router
  ...
  else if (strstr(lower, train5))
  {
   ...
   Serial.println(); res = "";  response ="";
  ...
  else if (strstr(lower, help))
    {
      ...
      Serial.println("Want to know the weather information of your city, just type - weather information CITY_NAME");
